...
urlpatterns = [
    ...
    path('quick-join/', views.quick_join_test, name='quick_join_test'),
    ...
    path('delete-single-question/<int:test_id>/<int:q_id>/', views.delete_single_question,
         name='delete_single_question'),
    ...
    path('api/delete-private-question/<int:q_id>/', views.api_delete_private_question,
         name='api_delete_private_question'),

    # 🚀 NAYA: Bulk Delete APIs (Danger Zone)
    path('api/empty-chapter/', views.api_empty_chapter_questions, name='api_empty_chapter_questions'),
    path('api/delete-category/', views.api_delete_category, name='api_delete_category'),
    path('api/rename-category/', views.api_rename_category, name='api_rename_category'),
